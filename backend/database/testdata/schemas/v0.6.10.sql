-- Schema-only dump for release v0.6.10 (migration version 51).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.10 -version 51`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000051 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (51, 0);
