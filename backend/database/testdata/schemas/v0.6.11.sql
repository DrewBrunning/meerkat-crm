-- Schema-only dump for release v0.6.11 (migration version 52).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.11 -version 52`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000052 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (52, 0);
