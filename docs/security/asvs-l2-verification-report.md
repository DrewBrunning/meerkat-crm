...
> **ASVS Level 2, with 29 documented exceptions.** **MASVS-L1, with 1 documented exception** (plus two
...
"L2 with 29 documented exceptions" is only meaningful if the exceptions are enumerable. They are.
